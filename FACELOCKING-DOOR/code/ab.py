...
m=0
d=0
dp = 'C:/Users/Michael/Desktop/img/'
f = os.listdir("C:/Users/Michael/Desktop/img")
...
for j in range(len(f)):
    ...
    model.train(np.asarray(Training_data),np.asarray(a))
   # model.train (Training_data,Lebels)
    print("training complete")
    q+=1
face_classifier = cv2.CascadeClassifier('C:/facelock/haarcascade_frontalface_default.xml')
...
if x>=5:
    ...
    var = 'a'
    c=var.encode()
    speak("Face recognition complete..it is matching with database...welcome.......Humanoid Robot..")
    speak("Door is openning for 5 seconds. with count to 0. 3, 2, 1, 0")
    ard.write(c)
    time.sleep(3)
elif c==30:
